...
const HomePage = () => {
  ...
  and developer tools and frameworks required for real-world applications.`
  ...
  return (
    ...
    <Card image={"https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80"} h2={textForCard} />
